<div id="adminLeft">
            <div id="adminMenu">
                <ul class="adminMenu" id="adminMenu1">
                    ...
                    <a href="/admin/gallery"><li class="active">갤러리</li></a>
    ...
    <div id="adminRight">
        ...
        <section id="albumDetailShow">
            ...
            <img src="/upload/gallery/<?=$data->file?>" alt="" style="width: 40%; margin-top:30px;">
        </section>
        <a href="/admin/gallery/delete/<?= $data->idx ?>" id="removeBtn"><button>삭제</button></a>
    </div>
    ...
    <script>
        ...
        function handleSaveClick() {
            ...
            elt.setAttribute('href', "/upload/gallery/<?=$data->file?>");
