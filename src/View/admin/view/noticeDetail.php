...
<div id="adminRight">
    ...
    <div style="display: flex; gap:10px; margin-left: 69%;">
        <a href="/admin/notice/accept/<?= $data->idx ?>" style="margin-left:0%;" id="removeBtn"><button style="background-color: #4E73A6; border:1px solid #4E73A6;"><?=$data->accept == 1 ? '공지해제' : '공지등록'?></button></a>
        <a href="/admin/notice/delete/<?= $data->idx ?>" style="margin-left:0%;" id="removeBtn"><button>삭제</button></a>
    </div>
</div>
