<div id="adminLeft">
        ...
        <div id="adminRight">
            ...
            <section id="noticeWrite">
                <h2>새소식 작성</h2>
                <form id="noticeWriteMain" action="/news/process" method="post" enctype="multipart/form-data">
                    <div>
                        <div>제목</div>
                ...
                <div id="noticeContent">
                    ...
                    <div id="noticeMainContent">
                        ...
                        foreach($data as $key=>$value) {
                            ?>
                            <a href="/admin/news/detail/<?=$data[$key]->idx?>" class="noticeColumn noticeLook">
