<div id="adminLeft">
            <div id="adminMenu">
                <ul class="adminMenu" id="adminMenu1">
                    ...
                    <a href="/admin/program"><li class="active">프로그램 일정표</li></a>
        ...
        <div id="adminRight">
            ...
            <section id="noticeWrite">
                <h2>프로그램 일정표 작성</h2>
                <form id="noticeWriteMain" action="/programUpdate/process" method="post" enctype="multipart/form-data">
                    <div>
                        <div>제목</div>
                ...
                <div id="noticeContent">
                    ...
                    <div id="noticeMainContent">
                        ...
                        foreach($data as $key=>$value) {
                            ?>
                            <a href="/admin/program/detail/<?=$data[$key]->idx?>" class="noticeColumn noticeLook">
